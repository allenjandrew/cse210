namespace Develop04.Classes
{
    ...
    public class ReflectingActivity : Activity
    {
        ...
        private void DisplayPrompt() // select a prompt from _promptList, display it for the user, and call base.LoadingScreen(_duration/2)
        {
        ...
        private void DisplayQuestion() // select and display prompt from _questionList, display it for the user, and call base.LoadingScreen(_duration/2)
        {
            Random tRex = new Random();
